                ...
                <div class="card">
                    ...
                    <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 float-left">
                            ...
                            <input type="number" name="square_meters" id="square_meters" class="form-control" autofocus>
                            @error('square_meters')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group col-md-6 float-right">
                            ...
                            <input type="number" name="constructed_meters" id="constructed_meters" class="form-control" autofocus>
                        ...
                        <div class="form-group col-md-6 float-right">
                            ...
                            <input type="text" name="city" id="city" class="form-control" disabled autofocus>
                            @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group col-md-6 float-left">
                            ...
                            <input type="text" name="street" id="street" class="form-control" disabled autofocus>
                            @error('street')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                @foreach($characteristics as $characteristic)
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="characteristic_{{ $characteristic->id }}">
                                            <i class="fa {{ $characteristic->icon }}" style="margin-right:5px!important;"></i> {{ $characteristic->name }}
                                        </label>
                                    </div>
                                @endforeach
                            </div>
